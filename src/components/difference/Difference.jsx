                    ...
                    <div className="row">
                        <div className="col-lg-4 col-md-3 mb-4">
                            <div className="difference-slide-img">
                                <img src={DifImage1} alt="difference image" />
                        ...
                        <div className="col-lg-4 col-md-3 mb-4">
                            <div className="difference-slide-img">
                                <img src={DifImage2} alt="difference image" />
                                <div className="dif-overlay d-flex justify-content-between align-content-center">
                                    <div>
                                        <p>Juhon Dew</p>
                                        <span>CEO</span>
                        ...
                        <div className="col-lg-4 col-md-3 mb-4">
                            <div className="difference-slide-img">
                                <img src={DifImage3} alt="difference image" />
                                <div className="dif-overlay d-flex justify-content-between align-content-center">
                                    <div>
                                        <p>MICHEAL DPE</p>
                                        <span>Manager</span>
                        ...
                        <div className="col-lg-4 col-md-3 mb-4">
                            <div className="difference-slide-img">
                                <img src={DifImage4} alt="difference image" />
                                <div className="dif-overlay d-flex justify-content-between align-content-center">
                                    <div>
                                        <p>Alan</p>
